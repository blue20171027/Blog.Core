...
namespace Blog.Core.Services.BASE
{
    public class BaseServices<TEntity> : IBaseServices<TEntity> where TEntity : class, new()
    {
            ...
            string strOrderByFileds = null)
        {
            ...
            return await BaseDal.QueryTabsPage(joinExpression, whereExpression, selectExpression, intPageIndex, intPageSize, strOrderByFileds);
        }
            ...
            string strOrderByFileds = null)
        {
            ...
            return await BaseDal.QueryTabsPage(joinExpression, whereExpression, groupExpression, selectExpression, intPageIndex, intPageSize, strOrderByFileds);
        }
    }
